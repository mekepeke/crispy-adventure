document.addEventListener('DOMContentLoaded', function() {
    ...
    function showSlides() {
        ...
        slideTimeout = setTimeout(showSlides, 15000); // Adjust the delay (in milliseconds) as needed
    }
    ...
    function currentSlide(n) {
        ...
        // Set a new timeout to resume automatic slideshow after delay
        slideTimeout = setTimeout(showSlides, 6000); // Adjust the delay (in milliseconds) as needed
    }
